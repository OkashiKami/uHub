...
//		public Generator.Output previewOutput {get;set;}
        ...
        //Water
        public bool guiWaterSettings;
        public Transform target;
        public Transform t;
        public bool useMainCamera = true;
        public GameObject WaterPrefab;
        public GameObject water;
        public float WaterLevl = 0.25f;
...
public bool guiInstantUpdateEnabled = false;
        ...
        private void doWater()
        {
            ...
            {
                if (!target && !useMainCamera) return;
                if (useMainCamera && !Camera.main) return;

                if (!target && useMainCamera) t = Camera.main.transform;
                else if (target && !useMainCamera) t = target;
                else if (target && useMainCamera) t = target;

                water.transform.position = new Vector3(t.position.x, WaterLevl, t.position.z);
            }
        }
